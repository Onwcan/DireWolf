...
### M4 · Brokers: filesystem, exec, secrets — **INCOMPLETE** (M4a and M4b complete; M4c implemented, candidate for acceptance; M4d–M4e not started)
